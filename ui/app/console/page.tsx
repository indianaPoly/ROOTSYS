    ...
    <main id="content" className="page">
      <Reveal>
        <section className="hero">
          ...
          <p className="lede">
            This dashboard reads actual JSONL outputs produced by smoke and complex pipeline checks. It is intended to confirm real run status
            before wiring frontend-driven workflows.
          </p>
